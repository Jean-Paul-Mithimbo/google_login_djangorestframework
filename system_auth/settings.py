"""
Django settings for system_auth project.
...
SECRET_KEY = 'django-insecure-j7ul1ga5a+r2*l_4jp02(7bmx7srq6obb(4q6fkl%ttoo%uz+5'
...
WSGI_APPLICATION = 'system_auth.wsgi.application'
